...
import com.example.weshare.Adapters.CommentAdapter;
import com.example.weshare.Models.Comment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // post_detail_date_name
        posterName = findViewById(R.id.post_detail_date_name);
        posterName.setText(firebaseUser.getDisplayName());
        // ini Views
